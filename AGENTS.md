...
- Not verified: cross-tenant PUT on loans (same updateMany tenant scoping as vendors, not re-tested); backend probe results are recorded in a later docs commit.
